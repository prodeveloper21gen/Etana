  ...
  return (
    <Element name='footer'>
      <Box sx={{ paddingTop: { md: '600px', xs: '300px' } }}>
        ...
        <img src="/src/assets/svg/down.svg" style={{ maxWidth: '100%', height: 'auto', bottom: '0', position: 'absolute', zIndex: '50' }} alt="" />
        <Link to="header" smooth={true} duration={1500}>
          <img className='upAndDown' src="/src/assets/img/image copy 29.png" style={{ maxWidth: '30%', height: 'auto', bottom: '20px', position: 'absolute', zIndex: '50' }} alt="" />
        </Link>
        <img className='headDown' src="/src/assets/img/image copy 30.png" style={{ maxWidth: '30%', height: 'auto', bottom: '10px', right: '0', position: 'absolute', zIndex: '10' }} alt="" />
        <Box>
        </Box>
      </Box>
    </Element>
