...
const HeroSection = () => {
    ...
    return (<Box className="bacPosCenter" sx={{ position: 'relative', backgroundSize: 'contain', backgroundImage:'url("/src/assets/img/image copy 17.png")', backgroundRepeat: 'no-repeat' }}>
